...
export default function EntryLevelAssistantVideoEditorPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-32 lg:pt-40 pb-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-dark dark:to-dark">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 rounded-full text-sm font-medium">
              <span>🎬</span>
            ...
            <p className="mb-8 text-base text-body-color dark:text-body-color-dark md:text-lg max-w-3xl mx-auto leading-relaxed">
              Start your career in video editing with entry-level assistant positions. Perfect for beginners, 
              recent graduates, and those looking to break into the industry.
            </p>
      ...
      <section className="py-20 lg:py-24 bg-white dark:bg-gray-dark">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-8">
              <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-r from-green-400 to-green-500 rounded-full flex items-center justify-center text-4xl">
                🎬
              </div>
              <h2 className="mb-4 text-2xl font-bold text-black dark:text-white">
                What is an Entry Level Assistant Video Editor?
              </h2>
              <p className="text-lg text-body-color dark:text-body-color-dark">
                Your gateway to the video editing industry
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-dark/50 rounded-xl p-8 mb-8">
              ...
              <div className="grid gap-4 md:grid-cols-2 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-black dark:text-white">Footage Organization</h4>
                    <p className="text-sm text-body-color dark:text-body-color-dark">Sort and organize raw video footage</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold mt-1">2</div>
                  <div>
                    <h4 className="font-medium text-black dark:text-white">Basic Editing</h4>
                    <p className="text-sm text-body-color dark:text-body-color-dark">Perform simple cuts and transitions</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold mt-1">3</div>
                  <div>
                    <h4 className="font-medium text-black dark:text-white">File Management</h4>
                    <p className="text-sm text-body-color dark:text-body-color-dark">Maintain organized project files</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold mt-1">4</div>
                  <div>
                    <h4 className="font-medium text-black dark:text-white">Support Senior Editors</h4>
                    <p className="text-sm text-body-color dark:text-body-color-dark">Assist with various editing tasks</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-primary/5 dark:bg-primary/10 rounded-xl p-6">
              ...
              <p className="text-body-color dark:text-body-color-dark mb-4">
                Explore our comprehensive guides and resources to prepare for your first assistant video editor role
              </p>
              <Link
        ...
        <div className="container">
          <div className="mb-16 text-center">
            ...
            <p className="text-base text-body-color dark:text-body-color-dark max-w-2xl mx-auto">
              Prepare yourself for entry-level positions with these helpful guides
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "How to Become",
                description: "Step-by-step guide to entering the industry",
              ...
              },
              {
                ...
                description: "Create compelling job applications",
